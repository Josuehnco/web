<?php
    ...
    class crud{
        ...
        {
           try {
            $conexion=new PDO("mysql:localhost","josue","1234", "centro de estampados");
            $con=new PDO('mysql:localhost","josue","1234", "centro de estampados');
            return $con;
...
$conexion=mysqli_connect("localhost","josue","1234", "centro de estampados");